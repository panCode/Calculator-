...
//     let initial_withdrawl=today_cost_per_annum*(Math.pow((1+i_rate/100),years_to_save));

//     let I=1+i_rate/100;
//     let Y=1+sip_rate/100;
//     let p_previous_last=initial_withdrawl*(1-(Math.pow((I/Y),duration_of_college)))/(1-I/Y);
...
//                 alignItems:'center'
//               }}>
//               <Text style = {{fontWeight:'normal',fontSize:17,color:'#1a1a1a'}}>Monthly SIP </Text>
//             </View>
//             <View style = {{flex:1,alignItems:'center'}}>
//                 <Text style = {{fontWeight:'normal',fontSize:17,color:'#1a1a1a'}}>Rs. {Number(monthly_savings.toFixed()).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")} </Text>  
//             </View>
//           </View>
//         </View>
